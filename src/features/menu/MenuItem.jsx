          ...
          <div className="space-x-2">
            {!soldOut && (
              <>
                ...
                {numInCart > 0 && (
                  <>
                    <span className="rounded-md border-2 border-stone-200 px-1.5 py-1 text-xs font-medium md:px-2.5 md:py-1.5 md:text-sm">
                      {numInCart}
                    </span>
                    <Button
                      type="delete"
                      size="small"
                      className="font-bold md:px-2.5 md:py-1.5 md:text-sm"
